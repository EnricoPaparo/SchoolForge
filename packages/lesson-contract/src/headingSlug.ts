 ...
 */
export function canonicalLessonHeadingText(rawText: string): string {
  return (
    rawText
 ...
 */
export function lessonHeadingSlug(canonicalText: string): string {
 ...
 */
export function nextLessonHeadingSlug(base: string, occurrences: Map<string, number>): string {
 ...
 * sola.
 */
export function assignLessonHeadingSlugs(
  headings: ReadonlyArray<{ text: string; level: 2 | 3 }>,
): LessonHeadingRef[] {
