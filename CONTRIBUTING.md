...
- Nessun lock basato su email: l'unicità della consegna digitale è garantita dal token mono-uso del tentativo. Lo studente dichiara nome e cognome (auto-dichiarati, non verificati); ogni accesso digitale è registrato con nome+IP+timestamp+user-agent come audit trail consultabile dal docente (visibilità, non enforcement).
