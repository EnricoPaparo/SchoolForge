...
**M4 — Correzione ed export — in corso.** Il docente corregge, completa e restituisce; lo studente consulta la propria restituzione. La tabella Consegne online è il Registro Correzioni ed esporta CSV interamente nel browser (M4-00→M4-03A completati). Export PDF/Markdown e Gate G6 restano da completare. Concept UX in [documentazione/m4-correzione-ux-concept.md](documentazione/m4-correzione-ux-concept.md). **QE — Question Editor** è già completato; **M5 — Correzione AI** resta rinviato alla V2.

**Didattica (DUX) — DUX-00→10A implementati.** Il workspace docente unificato ha sostituito Corsi/Lezioni/Domande; Classi è stata assorbita in Studenti, Verifiche è stata uniformata e la shell finale usa header unico responsive, Template a griglia e aurora statica. Sono inclusi editing coordinato dei metadata corso/anno e stabilità finale di azioni, tabelle ed export. Resta il Gate GDUX. Vedi [documentazione/didattica-ux-roadmap.md](documentazione/didattica-ux-roadmap.md) e il prototipo [documentazione/prototipi/didattica-workspace.html](documentazione/prototipi/didattica-workspace.html).
