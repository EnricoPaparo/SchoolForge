...
La baseline documentale v4.1 è completa. Non esiste ancora codice applicativo, configurazione Firebase o pipeline eseguibile. Il primo pacchetto da implementare è `F-01 — Workspace e CI`.
