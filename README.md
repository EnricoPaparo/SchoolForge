...
| Correzione assistita da IA (M5) | 🟡 **M5-00 progettato + M5-01/M5-02/M5-03 implementati** (motore server-side `onCall` in modalità mock: scoring chiuse deterministico, aperte via `MockAiGrader`, idempotenza; 0 token, nessuna chiamata esterna; **M5-03** UI batch: selezione stabile, toolbar «Correggi con IA», conferma costi con banner mock, colonna «Valutate», payload solo-ID) — vedi `documentazione/m5-ai-assisted-roadmap.md`; M5-04→M5-05 non ancora avviati |
