...
**Hardening V1 — completato.** Gate GHARD superato: operatività/costi, regioni, security header, accessibilità e import resiliente verificati; residui P3 accettati con soglie. Dopo Gate G7, il prossimo pacchetto tecnico IA è **HARD-NODE-01**: migrazione del runtime Functions da Node.js 20 e aggiornamento controllato di `firebase-functions`, con test e deploy separati.
