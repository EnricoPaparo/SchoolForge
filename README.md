...
| Correzione assistita da IA (M5) | 🟡 **M5-00 progettato** (contratto, UX batch, sicurezza, cost model) — vedi `documentazione/m5-ai-assisted-roadmap.md`; implementazione M5-01→M5-05 non ancora avviata |
...
**Hardening V1 — completato.** Gate GHARD superato: operatività/costi, regioni, security header, accessibilità e import resiliente verificati; residui P3 accettati con soglie. **M5-00 completato**: contratto, UX batch, sicurezza e cost model della correzione assistita da IA ([documentazione/m5-ai-assisted-roadmap.md](documentazione/m5-ai-assisted-roadmap.md)). Prossimo sviluppo: **M5-01** (gateway, feature flag, Secret Manager, provider mock).
