...
| [Didattica (DUX)](documentazione/didattica-ux-roadmap.md) | Redesign UX del workspace docente: Didattica ha assorbito Corsi/Lezioni/Domande e Classi è ora una scheda di Studenti. **DUX-00→04D e DUX-05A completati; DUX-05B/05C e Gate GDUX pendenti.** |
...
**Didattica (DUX) — DUX-00→04D e DUX-05A implementati.** Il workspace docente unificato ha sostituito le viste Corsi/Lezioni/Domande; Classi è stata assorbita nella sezione Studenti con contatori derivati client-side e senza nuove letture. Restano DUX-05B (coerenza Verifiche), DUX-05C (Template/header/aurora) e il Gate GDUX. Vedi [documentazione/didattica-ux-roadmap.md](documentazione/didattica-ux-roadmap.md) e il prototipo [documentazione/prototipi/didattica-workspace.html](documentazione/prototipi/didattica-workspace.html).
