...
| [Didattica (DUX)](documentazione/didattica-ux-roadmap.md) | Redesign UX del workspace docente: Didattica ha assorbito Corsi/Lezioni/Domande, Classi è ora una scheda di Studenti e Verifiche usa la creazione inline con feedback bozza persistente. **DUX-00→04D e DUX-05A/05B completati; DUX-05C e Gate GDUX pendenti.** |
...
**Didattica (DUX) — DUX-00→04D e DUX-05A/05B implementati.** Il workspace docente unificato ha sostituito le viste Corsi/Lezioni/Domande; Classi è stata assorbita in Studenti e Verifiche adotta tabella con creazione inline e feedback persistente del salvataggio bozza, senza nuove letture o modifiche ai service. Restano DUX-05C (Template/header/aurora) e il Gate GDUX. Vedi [documentazione/didattica-ux-roadmap.md](documentazione/didattica-ux-roadmap.md) e il prototipo [documentazione/prototipi/didattica-workspace.html](documentazione/prototipi/didattica-workspace.html).
