...
| Correzione e export risultati (M4) | 🚧 in corso — contratto, service/Rules e workspace docente di correzione (M4-00→M4-02) completati; Registro Correzioni ed export (M4-03) non ancora implementati |
...
7. **M4 — Correzione ed export** 🚧 *(dipende da M3-full, completato)*: contratto dati, service layer/Security Rules e workspace docente di correzione manuale (M4-00→M4-02) completati; punteggi, percentuali e feedback assegnabili e restituibili allo studente. Registro Correzioni ed export PDF/Markdown/CSV (M4-03) non ancora implementati.
...
V1 comprende M1, M2, M3-lite, RE, QE e M3-full (tutti implementati, Gate G5 superato per M3-full). M4 è in corso: contratto, service/Rules e workspace di correzione (M4-00→M4-02) completati; Registro Correzioni ed export (M4-03) restano da implementare. Il progetto può fermarsi dopo ogni modulo mantenendo un prodotto utile. M5 è rinviato alla V2.
...
**M4 — Correzione ed export — in corso.** Contratto dati, service layer/Security Rules e workspace docente di correzione manuale (M4-00→M4-02) sono completati: il docente assegna punteggi/feedback per domanda da un workspace dedicato aperto dalla tabella Consegne online, completa e restituisce la correzione allo studente. Registro Correzioni ed export PDF/Markdown/CSV (M4-03) non sono ancora implementati. Concept UX in [documentazione/m4-correzione-ux-concept.md](documentazione/m4-correzione-ux-concept.md). **QE — Question Editor** è già completato; **M5 — Correzione AI** resta rinviato alla V2.
