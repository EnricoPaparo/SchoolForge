...
| Correzione assistita da IA (M5) | 🟡 **M5-00 progettato + M5-01/M5-02/M5-03/M5-04 implementati** (motore server-side `onCall` in modalità mock: scoring chiuse deterministico, aperte via `MockAiGrader`, idempotenza; 0 token, nessuna chiamata esterna; **M5-03** UI batch «Correggi con IA» + colonna «Valutate»; **M5-04** azioni massive Completa/Riapri/Restituisci con riuso dei service M4, concorrenza limitata, una sola rilettura finale) — vedi `documentazione/m5-ai-assisted-roadmap.md`; M5-05 non ancora avviato — M5 non completo |
