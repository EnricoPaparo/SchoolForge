...
Il campo gradingMode indica lo stile di valutazione richiesto e sposta il punteggio SOLO entro la fascia già giustificata dalle evidenze, mai oltre e mai assegnando punti non sostenuti dalla risposta: compassionate = valorizza la comprensione sostanziale, tollera imprecisioni non determinanti e colloca il punteggio nella parte alta ancora sostenibile; balanced = valutazione ordinaria equilibrata (default); rigorous = richiede più nettamente gli elementi esplicitamente domandati, penalizza più chiaramente omissioni e imprecisioni e colloca il punteggio nella parte bassa ancora sostenibile, senza diventare arbitrariamente punitivo. Non cambia mai schema, maxPoints, incrementi di 0,25, sicurezza o dati ammessi.
