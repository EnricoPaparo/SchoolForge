...
export const AI_VISUAL_PROMPT_VERSION = 'schoolforge-sketch-prompt/v5' as const;
...
export const SCHOOLFORGE_SKETCH_PREAMBLE = [
  ...
  'Quando il soggetto dichiara un ordine stretto fra lunghezze, distanze o estensioni, usa la stessa origine, scala o linea di base e mostra estremi separati e direttamente confrontabili. Due valori dichiarati diversi non devono terminare nello stesso punto.',
  'Non usare traiettorie con origini o altezze differenti per dimostrare una distanza ordinata se il soggetto non definisce anche un piano di arrivo comune.',
