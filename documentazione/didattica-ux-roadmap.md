...
| UI-VERIFICHE-MOBILE-01 ✅ | Compattazione della card docente esclusivamente mobile: rimossa la fascia vuota della CTA non visibile su touch e trigger «Azioni» esteso alla riga completa. La riga metadati mostra inoltre un indicatore documento solo quando il PDF studente è abilitato, su desktop e mobile. **Implementato.** | UI-RECORD-ACTIONS-01 | Nessun dato o costo nuovo: riuso di `studentPdfEnabled` già caricato. Desktop invariato e smoke Chromium a 336/1440 px. |
