...
**Versione:** 1.0
**Data:** 10 luglio 2026
**Stato:** in implementazione — M3F-00/M3F-01/M3F-02/M3F-03/M3F-04/M3F-05/M3F-06 completati (documentazione, tipi/indici, service layer client-only, Security Rules, UI studente, toggle `onlineEnabled` e monitor docente, sessione obbligatoria e UX prova). Il tratto finale M3F-07→M3F-11 consolida modalità verifica per classe, protezione effettiva delle lezioni, rifiniture docente, disciplina dei costi e gate DEV.
