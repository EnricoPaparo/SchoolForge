...
**PERF-SEC-01B — remediation mirata:** implementa esclusivamente i finding dell'audit PERF-SEC-01A che vengono esplicitamente approvati, uno alla volta o in gruppi coerenti, ciascuno con la propria verifica come indicato nel report. Non introduce ottimizzazioni non derivate dall'audit.
