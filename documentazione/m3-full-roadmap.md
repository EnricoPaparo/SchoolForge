...
**Versione:** 1.0
**Data:** 10 luglio 2026
**Stato:** in implementazione — M3F-00/M3F-01/M3F-02/M3F-03/M3F-04/M3F-05/M3F-06/M3F-07/M3F-08/M3F-09 completati (documentazione, tipi/indici, service layer client-only, Security Rules, UI studente, toggle `onlineEnabled` e monitor docente, sessione obbligatoria e UX prova, Modalità verifica globale/per classe, proiezione sicura del corpo lezione in `publicLessons.content`, controllo `studentPdfEnabled` e rifinitura del monitor consegne). **M3F-08 chiude il rischio residuo di M3F-07**: Storage nega ora la lettura del Markdown lezione a chiunque non sia l'owner, quindi Modalità verifica è effettiva end-to-end. Nessun deploy fino a M3F-11 (rollout+migrazione DEV) — vedi §"M3F-08 rollout" più sotto. Il tratto finale M3F-10→M3F-11 aggiunge disciplina dei costi e gate DEV.
