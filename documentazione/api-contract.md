...
Il dataset attivo è v3: gli holdout A e B hanno trovato difetti distinti e sono
archiviati byte per byte; il nuovo holdout C resta indipendente dal candidato
corretto. Il contratto della proposta e quello dell'immagine condividono la
validazione delle etichette e richiedono che confronti fra posizioni, stati o
istanze siano distinguibili rispetto a un riferimento comune. Un errore `pre_invocation` registra costo zero,
