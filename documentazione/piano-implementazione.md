...
| LESSON-TUNE-01 ✅ | Benchmark esteso anti-overfitting: i 6 scenari storici restano immutabili e sono combinati con 6 nuovi casi interdisciplinari; split congelato 8 `tuning` + 4 `holdout`, versione del prompt registrata nei report, CLI separata fail-closed e protocollo che vieta di usare gli holdout per ritoccare il candidato già esaminato. | LESSON-MANUAL-03 | **Baseline e candidati A/B eseguiti:** baseline 33.237 µUSD; A 35.026 µUSD; B 33.597 µUSD. B elimina i blocker di A, riferimenti al perimetro e attività eccessive, ma è ancora **REVISIONE_SOSTANZIALE** per una contraddizione centrale fra massa e forza peso e diagnosi troppo assertive. Candidato C `lesson-tune-01-candidate-c-v1` preparato con audit generale di coerenza fra formule/definizioni/esempi, forza probatoria dei test, callout completi e pulizia lessicale; test verdi e dry-run: 8 chiamate, ≤16 tentativi, stima 94.084 µUSD, tetto 218.798 µUSD, zero secret/rete. Modello/listino/dataset/payload/token cap invariati. I 4 holdout restano intatti. Evidenze in [evidenze/lesson-tune-03-candidate-b-review.md](evidenze/lesson-tune-03-candidate-b-review.md). |
