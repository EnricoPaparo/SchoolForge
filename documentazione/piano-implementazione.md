...
| UI-VERIFICHE-MOBILE-01 ✅ | Card verifica docente mobile più compatta: nessuna riga riservata alla CTA touch, «Azioni» full-width; icona PDF nella riga metadati solo quando `studentPdfEnabled === true`, anche desktop. **Implementato.** | UI-RECORD-ACTIONS-01 | Solo presentazione; nessuna query/write/listener o modifica backend. Desktop verificato invariato. |
