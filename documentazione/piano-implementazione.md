...
| 2 | M5-QUALITY-01 ✅ / M5-QUALITY-02-FIX ✅, secondo benchmark richiesto | Primo benchmark sintetico reale eseguito: modalità aggregate coerenti ma `AUTOMATIC_CHECKS_FAILED` per anomalie reali e falsi positivi della fascia unica. Comparatore mode-aware, prompt mirato e aggregati tecnici implementati; nessuna nuova chiamata in questa PR. Secondo benchmark autorizzato e revisione docente ancora necessari; M5-QUALITY-02/G7 aperti. |
