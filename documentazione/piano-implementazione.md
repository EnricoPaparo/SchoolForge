...
| 6 | VEX-00 ✅ / VEX-00B ✅ (docs+prototipo) / VEX-01A/01B/02/03 | Gruppi equivalenti, assegnazione server-side persistente e varianti sicure senza esporre alternative. VEX-00B congela il contratto tecnico ([`vex-contract.md`](vex-contract.md)) e produce il prototipo statico del builder ([`prototipi/vex-builder.html`](prototipi/vex-builder.html)) — solo documentazione, nessun codice/Function/Rule/indice/schema/dipendenza. VEX-01A: modello dati + builder draft-time (rimuove `questionsPerStudent` inutilizzato, assorbito). VEX-01B: callable di assegnazione idempotente + isolamento alternative. VEX-02: flusso studente + correzione/restituzione filtrate + PDF studente disabilitato. VEX-03: hardening equità/costi/smoke. |
