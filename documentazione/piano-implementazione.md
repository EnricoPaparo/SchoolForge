...
| HARD-02A-FIX | Correzione P2-01: centralizzare Escape + focus trap + ripristino focus in `DialogShell` (riuso pattern `AttentionEventsDialog`), con test mirato; opzionale `aria-invalid`/`scope="col"`; smoke a11y manuale su DEV (contrasto/zoom/reflow/screen-reader). | HARD-02A | Non implementato. |
| HARD-02B | Resilienza (F06): chunking import ZIP e swap `publicLessons` oltre 500 mutazioni, preservando l'atomicità logica. Tocca `importRepository.ts`. | HARD-00 | Non implementato. |
