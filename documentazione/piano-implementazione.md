...
| VDIF-05 ✅ | **Consumer downstream**: svolgimento studente, correzione manuale, correzione IA, restituzione, PDF, CSV, ricevute e **privacy audit** end-to-end sull'elenco chiuso delle superfici. | VDIF-04 | **Implementato, non distribuito.** `same_questions` con differenziazione è server-resolved in tutti i consumer; correzione manuale/IA, restituzione e archivio usano soltanto gli order assegnati; numerazione locale densa; errori studente opachi; nessun metadato etichetta nei contratti studente, ricevute, export o run IA. Zero nuove operazioni Firebase. Evidenze in [`evidenze/vdif-05-consumer-audit.md`](evidenze/vdif-05-consumer-audit.md). **Gate GVDIF aperto.** |
