...
| VISUAL-ENRICHMENT-04 | **UI e renderer — chiuso nel codice.** VE-04A: renderer, letture condizionali e riancoraggio. VE-04B: dialog docente a macchina di stati esplicita, proposta testuale e immagine con costi/conferme distinti, bind/generate/promote, sostituzione, abandon/remove e refresh autorevole. | VE-03 | **Chiuso, non distribuito.** VE-05 resta aperto; GVISUAL PENDING. |
