...
**Stato: DUX-04D completato (Gate di parità PASS + rimozione viste legacy Corsi/Lezioni/Domande). DUX-04C completato (navigazione mobile a livelli + modalità Organizza). DUX-04B completato (editing completo lezioni nel workspace). DUX-04A completato (azioni Corso e UDA nel workspace). DUX-03 completato (schede Contenuto/Domande/Informazioni + Question Editor contestuale nel workspace). DUX-02 completato (workspace corso reale dentro Didattica). DUX-01 completato (libreria corsi `Didattica` reale). DUX-00 completato (specifica + prototipo).** La sezione docente corrente è Didattica; Corsi/Lezioni/Domande e i relativi componenti legacy sono stati rimossi dopo la verifica di parità. Classi resta separata fino a DUX-05 (vedi §21 "Strategia di migrazione" del documento).
