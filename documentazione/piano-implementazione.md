...
| CHUNK-RECOVERY-01 ✅ | Helper comune per i `dynamic import` PDF: riconosce chunk obsoleto dopo deploy, evita rejection non gestite, mostra messaggio di aggiornamento e pulsante «Ricarica pagina» senza reload automatico; integrato in Programma svolto PDF e riusabile dal futuro export correzioni. | PDF browser-side esistenti | **Implementato.** PDF singola lezione invariato; CORR-PDF-01 resta progettato. |
