...
| M5-01 | Gateway `aiCorrectionGateway` (Cloud Function scale-to-zero), **feature flag**, **Secret Manager**, interfaccia `AiGrader` + **provider mock** deterministico. | M5-00, HG-M5-1 | Nessun invio senza flag+chiave; chiave assente da client/repo/Firestore/log; gateway rifiuta non-owner. |
