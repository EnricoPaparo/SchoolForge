...
| POOL-TUNE-00 ✅ | Infrastruttura del benchmark qualitativo dei pool: 12 fonti reali congelate (8 tuning + 4 holdout), profile probe Economy/Quality, rubrica 10×0–4, blocker e runner locale protetto. | AIGEN-PROMPT-01, LESSON-TUNE-HOLDOUT-01 | **Implementato; nessuna chiamata reale.** Dataset e sorgenti ancorati a SHA-256; obiettivi di valutazione mai inviati al provider; payload, prompt, validazione, profili, listini e cost model reali riusati senza duplicazione. Dry-run predefinito senza secret/rete; esecuzione reale solo con doppio flag, Node 22, TTY e frase esatta. Zero Firestore/Storage. `POOL-TUNE-01` profile probe, `02` tuning, `03` holdout e Gate GPOOL-QUALITY restano aperti. Vedi `pool-quality-roadmap.md`. |
