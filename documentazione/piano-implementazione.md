...
## Appendice E — Polish della lettura lezioni

| Pacchetto | Sintesi | Dipendenze | Stato |
|---|---|---|---|
| LESSON-POLISH-01 ✅ | Renderer condiviso docente/studente in modalità `lesson`: tipografia da articolo, indice locale accessibile da `h2`/`h3` sanitizzati, ancore deterministiche, avanzamento di lettura client-only, callout/codice/tabelle/immagini rifiniti e responsive. Le anteprime editor conservano il renderer preesistente. | UI-POLISH-01, M3-lite | **Implementato; smoke visuale locale 1440/1024/390/320 superato, smoke DEV pendente.** Zero nuove letture/scritture Firebase, Storage, Functions, Rules, indici, schema, dipendenze o asset. Pacchetto post-GTWU: Gate GTWU resta PASS. |
