...
| LESSON-MANUAL-02 📐 | Protocollo di valutazione della qualità delle **lezioni generate dal prompt attuale**, prima di modificarlo: dataset JSON con 6 scenari (teoria, procedura, esempi, esercizi, avanzata, confine UDA), rubrica a 15 dimensioni con scala 0–4 e blocker, protocollo di review nelle viste docente/studente e classificazione del problema fra prompt, renderer, metadati e variabilità. | LESSON-MANUAL-01, AIGEN-PROMPT-01, AIGEN-CONTEXT-01 | **Protocollo applicato allo split tuning esteso:** baseline economy reale 8/8 e review tecnica completate in LESSON-TUNE-01; conferma disciplinare/visiva docente ancora obbligatoria. Verdetto baseline: **REVISIONE_SOSTANZIALE**. Vedi [evidenze/lesson-tune-01-baseline-review.md](evidenze/lesson-tune-01-baseline-review.md). |
...
| LESSON-TUNE-01 ✅ | Benchmark esteso anti-overfitting: i 6 scenari storici restano immutabili e sono combinati con 6 nuovi casi interdisciplinari; split congelato 8 `tuning` + 4 `holdout`, versione del prompt registrata nei report, CLI separata fail-closed e protocollo che vieta di usare gli holdout per ritoccare il candidato già esaminato. | LESSON-MANUAL-03 | **Baseline e candidati A/B/C eseguiti.** C corregge il blocker massa/peso di B e migliora la struttura, ma fallisce su un esercizio IPv4 con premesse incompatibili. Sette costi C noti sommano 27.618 µUSD; `LT01-09` ha billing risk, quindi totale effettivo non determinabile; tetto 218.798 µUSD. Candidato D `lesson-tune-01-candidate-d-v1` preparato con audit generale di compatibilità delle premesse e precisione terminologica. Test verdi; dry-run D: 8 chiamate, ≤16 tentativi, stima 94.084 µUSD, tetto 221.610 µUSD, zero secret/rete. Modello/listino/dataset/payload/token cap invariati; holdout intatti. Evidenze in [evidenze/lesson-tune-04-candidate-c-review.md](evidenze/lesson-tune-04-candidate-c-review.md). |
| LESSON-TUNE-MODEL-01 ✅ | Confronto controllato sul candidato D: stesso prompt, dataset, otto casi tuning, payload e token cap; unica variabile `economy` vs `quality`. | LESSON-TUNE-01 | D economy respinto per blocker IPv4 e trasferimento termico; quality/Luna completato 8/8 con tutti gli scenari `PASS` e verdetto tuning **PROMPT_INVARIATO**. Sette costi noti quality: 150.771 µUSD; `LM02-04` con billing risk, totale effettivo `null`; tetto 1.070.842 µUSD. Holdout ancora ineseguiti e protetti; nessuna promozione runtime. Evidenze in [evidenze/lesson-tune-05-candidate-d-review.md](evidenze/lesson-tune-05-candidate-d-review.md) e [evidenze/lesson-tune-06-quality-review.md](evidenze/lesson-tune-06-quality-review.md). |
| LESSON-TUNE-HOLDOUT-01 📐 | Apertura controllata dei quattro holdout congelati sul candidato D quality, senza modificare prompt, dataset, payload o token cap. | LESSON-TUNE-MODEL-01 | Runner fail-closed su split/profilo espliciti e frase dedicata; dry-run Node 22: 4 chiamate, ≤8 tentativi, stima 328.037 µUSD, tetto 741.080 µUSD, zero secret/provider/rete. Esecuzione reale non autorizzata; dopo il merge serve consenso economico distinto. |
