...
| DUX-04B | Editing completo **lezione** nel workspace (contenuto Markdown, metadata, creazione/eliminazione lezione). | DUX-04A | Riuso service Repository Editor; dirty-guard esteso; nessuna nuova Rule. |
