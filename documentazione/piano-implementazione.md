...
| LESSON-TUNE-01 ✅ | Benchmark esteso anti-overfitting: i 6 scenari storici restano immutabili e sono combinati con 6 nuovi casi interdisciplinari; split congelato 8 `tuning` + 4 `holdout`, versione del prompt registrata nei report, CLI separata fail-closed e protocollo che vieta di usare gli holdout per ritoccare il candidato già esaminato. | LESSON-MANUAL-03 | **Baseline e candidato A eseguiti:** baseline 33.237 µUSD; candidato A 35.026 µUSD. A elimina LaTeX/H1 duplicati ma è respinto per due esercizi centrali errati, riferimenti al perimetro e attività teoriche eccessive: verdetto ancora **REVISIONE_SOSTANZIALE**. Candidato B `lesson-tune-01-candidate-b-v1` preparato con controlli causali, ricalcolo obbligatorio e limite operativo sulle attività teoriche; test verdi e dry-run: 8 chiamate, ≤16 tentativi, stima 94.084 µUSD, tetto 215.978 µUSD, zero secret/rete. Modello/listino/payload/token cap invariati. I 4 holdout restano intatti. Evidenze in [evidenze/lesson-tune-02-candidate-a-review.md](evidenze/lesson-tune-02-candidate-a-review.md). |
