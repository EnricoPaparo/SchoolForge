...
| VEX-02B ✅ | Correzione/IA/restituzione/export sulla sola variante. | Risolutore canonico `resolveAssignedQuestions`; scheletro correzione + totali + return + payload IA su `assignedQuestionOrders` (fail-closed); IA esclude consegne a variante malformata; PDF docente completo invariato, registro/CSV su totali variante. |
