...
**Resta a M5-04/05 (non implementati):** azioni massive Completa/Riapri/Restituisci = **M5-04**; provider reale su DEV + Secret Manager + budget + Gate G7 = **M5-05** (HG-M5-1/2/3/4 bloccanti). **M5-03 è implementato** (UI batch: checkbox, toolbar «Correggi con IA», conferma costi, colonna «Valutate»).

### 16.3 Stato M5-03 (implementato) — cosa resta a M5-04
...
**Resta a M5-04** (non implementato): azioni massive Completa/Riapri/Restituisci sulle sole righe selezionate ed eleggibili.
