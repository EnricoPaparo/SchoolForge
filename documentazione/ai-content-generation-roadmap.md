...
>
> **LESSON-TUNE-01 — baseline tuning reale e candidato A:** gli 8 scenari `tuning` sono stati generati col prompt `aigen-prompt-01-context-01-v1` e profilo economy (33.237 µUSD, 0,033237 USD, zero Firestore/Storage, nessun billing risk). La review ha rilevato LaTeX incompatibile col renderer in matematica/fisica, struttura e recap meccanici, precisione epistemica insufficiente e refusi ricorrenti: verdetto **REVISIONE_SOSTANZIALE**. Il candidato `lesson-tune-01-candidate-a-v1` rende esercizi e autoverifiche subordinati al valore didattico, vieta LaTeX/Mermaid finché non supportati, richiede corpo-only/struttura proporzionata/rigore epistemico/controllo finale. Modello, listino, payload, token cap e sicurezza invariati. I 4 holdout restano ineseguiti e protetti fino al congelamento del candidato.
>
