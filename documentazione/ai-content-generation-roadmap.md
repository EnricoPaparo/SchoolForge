...
>
> **LESSON-TUNE-01 — baseline, candidati A/B e candidato C:** baseline reale 8/8 (33.237 µUSD), candidato A 8/8 (35.026 µUSD) e candidato B 8/8 (33.597 µUSD), tutti economy e senza Firestore/Storage. B corregge i due blocker di A, rispetta il perimetro e riduce le attività, ma resta **REVISIONE_SOSTANZIALE** per una contraddizione centrale fra massa e forza peso e per diagnosi ancora troppo assertive. Il candidato `lesson-tune-01-candidate-c-v1` aggiunge audit generale di coerenza fra formule/definizioni/esempi, forza probatoria dei test, callout completi e pulizia lessicale. Test verdi; dry-run: 8 chiamate, ≤16 tentativi, stima 94.084 µUSD, tetto 218.798 µUSD, zero secret/rete. Modello, listino, dataset, payload, token cap e sicurezza invariati. I 4 holdout restano ineseguiti e protetti.
>
