...
>
> **LESSON-TUNE-01 — baseline, candidato A e candidato B:** baseline reale 8/8 (33.237 µUSD) e candidato A 8/8 (35.026 µUSD), entrambi economy e senza Firestore/Storage. A elimina completamente LaTeX e H1 duplicati ma resta **REVISIONE_SOSTANZIALE** per due esercizi centrali errati, riferimenti espliciti al perimetro, refusi e troppe attività teoriche. Il candidato `lesson-tune-01-candidate-b-v1` aggiunge controlli generali su causalità, equivalenza dei procedimenti, ricalcolo delle soluzioni, evidenze ipotetiche, perimetro e numero delle attività. Test verdi; dry-run: 8 chiamate, ≤16 tentativi, stima 94.084 µUSD, tetto 215.978 µUSD, zero secret/rete. Modello, listino, payload, token cap e sicurezza invariati. I 4 holdout restano ineseguiti e protetti.
>
