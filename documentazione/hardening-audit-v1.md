...
- **Stato (dopo HARD-01A):** **MITIGATED — documentazione pronta, configurazione manuale pending.** Runbook operativo (`runbook-operativo-v1.md`) e Human Gate (`evidenze/hard-01a-human-gate.md`) creati; restano le azioni manuali del docente (budget alert DEV, verifica destinatario, approvazione politica backup) — il finding sarà **risolto** solo a Human Gate completato.
