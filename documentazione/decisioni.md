...
| ADR-09 | Secret Manager solo per IA | ✅ Chiusa | architettura.md | Introdotto solo in M5 (dal pacchetto M5-01) per la chiave API del provider IA, letta unicamente dalla Cloud Function `aiCorrectionGateway`. |
