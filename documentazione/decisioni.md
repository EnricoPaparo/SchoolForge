...
|---|---|---|---|---|
| D-01 | Identità studente non verificata | ✅ Chiusa | analisi-requisiti.md | Lo studente dichiara nome e cognome (auto-dichiarati, non verificati); nessuna autenticazione studente. |
...
| ADR-06 | Portale pubblico e token sessione | ✅ Chiusa | architettura.md | Link non enumerabile; token sessione firmato server-side via cookie sicuro. |
