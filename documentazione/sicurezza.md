...
VE-05A. Gli holdout A e B non hanno superato il gate e sono archiviati: le loro
fonti non possono essere riutilizzate per validare le correzioni. Il dataset v3
contiene un holdout C indipendente. Un fallimento `pre_invocation` dimostra zero
