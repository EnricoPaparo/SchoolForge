...
VE-05A. Il primo holdout A non ha superato il gate ed è archiviato: le sue fonti
non possono essere riutilizzate per validare la correzione. Il dataset v2
contiene un holdout B indipendente. Un fallimento `pre_invocation` dimostra zero
