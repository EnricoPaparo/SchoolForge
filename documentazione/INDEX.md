...
19. [visual-enrichment-roadmap.md](visual-enrichment-roadmap.md) — **VISUAL-ENRICHMENT**: arricchimento visivo delle lezioni con una sola piccola illustrazione IA in stile fisso «SchoolForge Sketch v1». **VISUAL-ENRICHMENT-00→04 chiusi nel codice e non distribuiti; VE-05 aperto; Gate GVISUAL PENDING.** VE-04B completa il workflow docente con proposta, costi separati, generazione, approvazione, sostituzione, abbandono e rimozione. Prototipo statico: [prototipi/lesson-visual-enrichment.html](prototipi/lesson-visual-enrichment.html); review di fase: [evidenze/visual-enrichment-00-review.md](evidenze/visual-enrichment-00-review.md).
...
| [visual-enrichment-roadmap.md](visual-enrichment-roadmap.md) | Contratto VISUAL-ENRICHMENT: manifest visivo chiuso, ancoraggio senza riscrivere il Markdown, proiezione studente senza accesso Storage, ciclo di vita, UI docente e cleanup. **VE-00→04 chiusi nel codice e non distribuiti; VE-05 aperto; Gate GVISUAL PENDING.** | Per progettare o implementare VE-05. |
