...
**Didattica (DUX) — redesign UX in corso, DUX-01–04 completati (Didattica ha assorbito Corsi/Lezioni/Domande, viste legacy rimosse).** DUX-00 (specifica + prototipo), DUX-01–03 (libreria corsi, workspace corso, schede Contenuto/Domande/Informazioni con Question Editor contestuale) e DUX-04A–D (azioni Corso/UDA, editing lezioni, navigazione mobile, Organizza e — dopo il **Gate di parità PASS**, vedi [evidenze/dux-04d-matrice-parita.md](evidenze/dux-04d-matrice-parita.md) — rimozione delle viste legacy Corsi/Lezioni/Domande) sono realizzati — vedi [didattica-ux-roadmap.md](didattica-ux-roadmap.md). La nav docente è ora Didattica/Verifiche/Classi/Studenti/Template; **Classi** resta voce autonoma fino a DUX-05 (assorbimento in Studenti).
...
| [didattica-ux-roadmap.md](didattica-ux-roadmap.md) | Specifica UX del redesign "Didattica" (DUX-00–05 + Gate GDUX): unifica Corsi/Lezioni/Domande in un unico workspace docente. **DUX-01–04 completati: Didattica ha assorbito Corsi/Lezioni/Domande e le viste legacy sono state rimosse (Gate 04D PASS); solo DUX-05 da fare.** | Per consultare architettura informativa, invarianti di sicurezza/costo e roadmap DUX prima di iniziare DUX-05. |
