...
**Didattica (DUX) — implementazione DUX-01–05C completata.** Didattica ha assorbito Corsi/Lezioni/Domande dopo il **Gate di parità PASS** (vedi [evidenze/dux-04d-matrice-parita.md](evidenze/dux-04d-matrice-parita.md)); Classi è una scheda di Studenti, Verifiche è uniformata e la shell finale usa header unico responsive, Template restaurato e aurora sobria. Resta Gate GDUX — vedi [didattica-ux-roadmap.md](didattica-ux-roadmap.md).
...
| [didattica-ux-roadmap.md](didattica-ux-roadmap.md) | Specifica UX del redesign "Didattica" (DUX-00–05 + Gate GDUX). **DUX-01–05C completati: viste legacy rimosse, Classi assorbita in Studenti, Verifiche uniformata e shell finale applicata; Gate GDUX pendente.** | Per consultare architettura informativa, invarianti di sicurezza/costo e prossimo Gate GDUX. |
