...
17. [mappa-concettuale-roadmap.md](mappa-concettuale-roadmap.md) — mappa concettuale della lezione: output IA strutturato e composto dal server, Markdown modificabile, diagramma a caratteri e proiezione studente presente solo a lezione svolta. **CONCEPT-MAP-01→05 implementati** (core e backend IA; persistenza e proiezione condizionale; interfaccia; mappa come scheda della lezione; **quality-only** e artefatto **v2** Sintesi + Diagramma, con lettura compatibile delle mappe v1 già salvate e nessuna migrazione). **Rollout DEV e gate umano ancora aperti**: nessun deploy, nessuna generazione OpenAI reale.
