...
19. [visual-enrichment-roadmap.md](visual-enrichment-roadmap.md) — **VISUAL-ENRICHMENT**: arricchimento visivo delle lezioni con una sola piccola illustrazione IA in stile fisso «SchoolForge Sketch v1». **VISUAL-ENRICHMENT-00→02 implementati; VE-03→05 aperti; Gate GVISUAL PENDING.** VE-02 aggiunge callable, provider iniettato, normalizzazione WebP, staging/replay/cleanup e cost model, ma resta non distribuito: nessuna UI, proiezione studente o chiamata OpenAI reale. Prototipo statico: [prototipi/lesson-visual-enrichment.html](prototipi/lesson-visual-enrichment.html); review di fase: [evidenze/visual-enrichment-00-review.md](evidenze/visual-enrichment-00-review.md).
