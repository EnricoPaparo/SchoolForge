...
**Didattica (DUX) — redesign UX in corso, DUX-01–03 e DUX-04A–C implementati.** DUX-00 (specifica + prototipo), DUX-01–03 (libreria corsi, workspace corso, schede Contenuto/Domande/Informazioni con Question Editor contestuale) e DUX-04A–C (azioni Corso/UDA, editing lezioni, navigazione mobile e Organizza nel workspace) sono realizzati — vedi [didattica-ux-roadmap.md](didattica-ux-roadmap.md). Le sezioni legacy Corsi, Lezioni, Domande e Classi restano quelle attuali e pienamente funzionanti finché i pacchetti DUX-04D e DUX-05 non le sostituiscono a fasi, con parità funzionale verificata a ogni passaggio.
...
| [didattica-ux-roadmap.md](didattica-ux-roadmap.md) | Specifica UX del redesign "Didattica" (DUX-00–05 + Gate GDUX): unifica Corsi/Lezioni/Domande in un unico workspace docente. **DUX-01–03 e DUX-04A–C implementati (libreria + workspace con schede e azioni Corso/UDA); DUX-04D, DUX-05 da fare.** | Per consultare architettura informativa, invarianti di sicurezza/costo e roadmap DUX prima di iniziare DUX-04D. |
