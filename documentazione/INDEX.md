...
15. [lesson-quality-depth-roadmap.md](lesson-quality-depth-roadmap.md) — profondità delle lezioni generate: i concetti chiave dicono che cosa trattare, non quanto scrivere. Diagnosi, candidato E, tuning e holdout completati. **Gate GLESSON PASS** — [evidenza](evidenze/glesson-checklist-finale.md).
...
19. [visual-enrichment-roadmap.md](visual-enrichment-roadmap.md) — **VISUAL-ENRICHMENT**: arricchimento visivo delle lezioni con una sola piccola illustrazione IA in stile fisso «SchoolForge Sketch v1». **VISUAL-ENRICHMENT-00→04 chiusi nel codice e non distribuiti; VE-05A implementata senza chiamate reali o deploy; VE-05 aperto; Gate GVISUAL PENDING.** Evidenza benchmark: [evidenze/visual-enrichment-05a-benchmark.md](evidenze/visual-enrichment-05a-benchmark.md).
20. [agent-orchestrator-roadmap.md](agent-orchestrator-roadmap.md) — **AGENT-ORCHESTRATOR**: protocollo leggero Codex→Claude→CI→review, con GitHub come registro durevole, massimo quattro cicli, recovery delle quote e gate umani espliciti. **ORCHESTRATOR-00 documentale; ORCHESTRATOR-01 implementato** (adapter locale `tools/agent-orchestrator/`, preflight reale Claude Code Pro verificato); **ORCHESTRATOR-02→03 aperti; deliverable del pilot ORCHESTRATOR-04 (`MULTI-VISUAL-00`) prodotti manualmente, fermi a `gate:human`; Gate GORCH aperto.**
21. [multi-visual-roadmap.md](multi-visual-roadmap.md) — **MULTI-VISUAL**: estensione di VISUAL-ENRICHMENT a un massimo di tre immagini per lezione, generate o caricate dal docente, con compatibilità di lettura del manifest singolo esistente e adozione lazy alla prima seconda immagine. **MULTI-VISUAL-00 — contratto e prototipo (PR #423); MULTI-VISUAL-01 — tipi e validatori puri; MULTI-VISUAL-02 — proposta coordinata interna e upload binario owner-only implementati**, senza UI/Rules/proiezione/deploy; **MULTI-VISUAL-03→05 aperti.** Prototipo: [prototipi/lesson-multi-visual.html](prototipi/lesson-multi-visual.html). **Gate GMULTI: PENDING.**
...
| [visual-enrichment-roadmap.md](visual-enrichment-roadmap.md) | Contratto VISUAL-ENRICHMENT: manifest visivo chiuso, ancoraggio senza riscrivere il Markdown, proiezione studente senza accesso Storage, ciclo di vita, UI docente e cleanup. **VE-00→04 chiusi nel codice e non distribuiti; VE-05A implementata senza chiamate reali o deploy; VE-05 aperto; Gate GVISUAL PENDING.** | Per eseguire e valutare VE-05. |
| [agent-orchestrator-roadmap.md](agent-orchestrator-roadmap.md) | Contratto dell'orchestrazione Codex/Claude: ruoli, task manifest, stati, review, quote, recovery, sicurezza e pilot multi-immagine. | Per eseguire sviluppo agentico fino al gate umano senza passaggi manuali intermedi. |
| [multi-visual-roadmap.md](multi-visual-roadmap.md) | Contratto MULTI-VISUAL: fino a tre immagini per lezione (generate o caricate), forme dati chiuse, adozione lazy dal manifest singolo VE, ancoraggio N-way, cost model per immagine, rollout/rollback a flag separati lettura/scrittura. | Per consultare il pilot `MULTI-VISUAL-00` di `AGENT-ORCHESTRATOR` ed eseguire le fasi implementative successive. |
...
- [evidenze/visual-enrichment-00-review.md](evidenze/visual-enrichment-00-review.md) — review della fase documentale VISUAL-ENRICHMENT-00: percorsi reali verificati, vincolo Storage che ha determinato l'architettura, verifiche statiche del prototipo e **verifiche non eseguite** (smoke browser a 1440/1024/390/320 px e qualità delle immagini). **Gate GVISUAL PENDING.**
- [evidenze/visual-enrichment-05a-benchmark.md](evidenze/visual-enrichment-05a-benchmark.md) — dataset congelato 8+4, rubriche proposta/immagine, blocker, runner dry-run fail-closed, checkpoint/resume e checklist future; **zero chiamate reali, rollout DEV non eseguito, GVISUAL PENDING**.
- [evidenze/agent-orchestrator-00-review.md](evidenze/agent-orchestrator-00-review.md) — audit dell'ambiente, decisione subscription-first, rischi dell'adapter Claude e Gate GORCH-00.
- [evidenze/agent-orchestrator-01-review.md](evidenze/agent-orchestrator-01-review.md) — adapter locale `tools/agent-orchestrator/` (preflight, invocazione non interattiva, checkpoint atomico, classificazione esiti, resume, CLI), gate eseguiti localmente, matrice exit code, cost model e limiti residui.
- [evidenze/multi-visual-00-review.md](evidenze/multi-visual-00-review.md) — review del pilot `MULTI-VISUAL-00`: perimetro del diff, verifiche statiche e smoke responsive reale del prototipo multi-immagine, domande aperte per il Gate GMULTI.
