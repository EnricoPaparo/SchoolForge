...
- [evidenze/hard-01b-dev-smoke.md](evidenze/hard-01b-dev-smoke.md) — **HARD-01B** smoke DEV: checklist di verifica su DEV dei security header/CSP e della cache di Hosting (login Google, rendering, download, verifica online, gateway) per chiudere HARD-F03. Stato iniziale voci: `PENDING`.
