...
**Didattica (DUX) — redesign UX in corso, DUX-01–03 e DUX-04A implementati.** DUX-00 (specifica + prototipo), DUX-01–03 (libreria corsi, workspace corso, schede Contenuto/Domande/Informazioni con Question Editor contestuale) e DUX-04A (azioni Corso/UDA nel workspace) sono realizzati — vedi [didattica-ux-roadmap.md](didattica-ux-roadmap.md). Le sezioni legacy Corsi, Lezioni, Domande e Classi restano quelle attuali e pienamente funzionanti finché i pacchetti DUX-04B→D e DUX-05 non le sostituiscono a fasi, con parità funzionale verificata a ogni passaggio.
