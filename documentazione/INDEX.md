...
19. [visual-enrichment-roadmap.md](visual-enrichment-roadmap.md) — **VISUAL-ENRICHMENT**: arricchimento visivo delle lezioni con una sola piccola illustrazione IA in stile fisso «SchoolForge Sketch v1», approvata dal docente e visibile allo studente solo a lezione svolta. **VISUAL-ENRICHMENT-00 (contratto/prototipo) e VE-01 (proposta testuale e contratti puri) implementati; VE-02→05 aperti; Gate GVISUAL PENDING.** VE-01 non rende disponibile alcuna funzionalità: nessuna immagine, UI, persistenza o deploy. Prototipo statico: [prototipi/lesson-visual-enrichment.html](prototipi/lesson-visual-enrichment.html); review di fase: [evidenze/visual-enrichment-00-review.md](evidenze/visual-enrichment-00-review.md).
...
| [visual-enrichment-roadmap.md](visual-enrichment-roadmap.md) | Contratto VISUAL-ENRICHMENT: manifest visivo chiuso, ancoraggio senza riscrivere il Markdown, proiezione studente senza accesso Storage, ciclo di vita e cleanup dell'asset, cost model. **Fase 00 documentale; VE-01 implementata (quarto kind IA `visual_proposal`, contratti puri); Gate GVISUAL PENDING.** | Per progettare o implementare VE-02→05. |
