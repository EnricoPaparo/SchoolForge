...
19. [visual-enrichment-roadmap.md](visual-enrichment-roadmap.md) — **VISUAL-ENRICHMENT**: arricchimento visivo delle lezioni con una sola piccola illustrazione IA in stile fisso «SchoolForge Sketch v1». **VISUAL-ENRICHMENT-00→03 chiusi; VE-04 suddiviso in A + B con VE-04A implementato e VE-04B aperto; VE-05 aperto; Gate GVISUAL PENDING.** VE-03C chiude la fase: export ZIP con manifest e WebP canonico tramite l'unica callable binaria owner-only, import che ignora i file visuali, lifecycle provato end-to-end e cost model misurato. Tutto il backend resta **non distribuito**, senza UI e senza chiamate OpenAI reali. Prototipo statico: [prototipi/lesson-visual-enrichment.html](prototipi/lesson-visual-enrichment.html); review di fase: [evidenze/visual-enrichment-00-review.md](evidenze/visual-enrichment-00-review.md).
...
| [visual-enrichment-roadmap.md](visual-enrichment-roadmap.md) | Contratto VISUAL-ENRICHMENT: manifest visivo chiuso, ancoraggio senza riscrivere il Markdown, proiezione studente senza accesso Storage, ciclo di vita e cleanup dell'asset, cost model. **VE-00→03 chiusi; VE-04A implementato, VE-04B e VE-05 aperti; Gate GVISUAL PENDING.** | Per progettare o implementare VE-04B e VE-05. |
