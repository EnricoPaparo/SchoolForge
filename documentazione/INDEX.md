...
19. [visual-enrichment-roadmap.md](visual-enrichment-roadmap.md) — **VISUAL-ENRICHMENT**: arricchimento visivo delle lezioni con una sola piccola illustrazione IA in stile fisso «SchoolForge Sketch v1». **VISUAL-ENRICHMENT-00→02 e VE-03A/03B implementati; VE-03, VE-03C, VE-04 e VE-05 aperti; Gate GVISUAL PENDING.** VE-03B rende server-side il completamento, la rimozione, l'abbandono e il cleanup delle cancellazioni, ma resta non distribuito e senza UI o chiamate OpenAI reali. Prototipo statico: [prototipi/lesson-visual-enrichment.html](prototipi/lesson-visual-enrichment.html); review di fase: [evidenze/visual-enrichment-00-review.md](evidenze/visual-enrichment-00-review.md).
...
| [visual-enrichment-roadmap.md](visual-enrichment-roadmap.md) | Contratto VISUAL-ENRICHMENT: manifest visivo chiuso, ancoraggio senza riscrivere il Markdown, proiezione studente senza accesso Storage, ciclo di vita e cleanup dell'asset, cost model. **VE-00→02 e VE-03A/03B implementati; VE-03/03C→05 aperti; Gate GVISUAL PENDING.** | Per progettare o implementare VE-03C→05. |
