...
16. [verifiche-differenziate-roadmap.md](verifiche-differenziate-roadmap.md) — verifiche differenziate per etichetta (VDIF) ed esiti per lezione (ESITI-01, sola lettura, derivazione pura). **VDIF-00 completato** (contratto congelato, perimetro privacy a elenco chiuso, mutua esclusione VEX bidirezionale, guardie di attivazione, cost model, matrice di test e [prototipo](prototipi/verifiche-differenziate.html)) e **VDIF-01 implementato**: registro etichette owner-only a otto chiavi, unicità transazionale con prenotazione SHA-256 del nome, CRUD atomico con audit, Rules owner-only e terza scheda «Etichette» in Studenti. **VDIF-02→05 aperti, nessun rollout dichiarato, Gate GVDIF aperto.**
