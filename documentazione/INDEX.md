...
19. [visual-enrichment-roadmap.md](visual-enrichment-roadmap.md) — **VISUAL-ENRICHMENT**: arricchimento visivo delle lezioni con una sola piccola illustrazione IA in stile fisso «SchoolForge Sketch v1», approvata dal docente e visibile allo studente solo a lezione svolta. **VISUAL-ENRICHMENT-00 implementato come contratto/prototipo; VE-01→05 aperti; Gate GVISUAL PENDING.** Prototipo statico: [prototipi/lesson-visual-enrichment.html](prototipi/lesson-visual-enrichment.html); review di fase: [evidenze/visual-enrichment-00-review.md](evidenze/visual-enrichment-00-review.md).
