...
| [visual-enrichment-roadmap.md](visual-enrichment-roadmap.md) | Contratto VISUAL-ENRICHMENT: manifest visivo chiuso, ancoraggio senza riscrivere il Markdown, proiezione studente senza accesso Storage, ciclo di vita e cleanup dell'asset, cost model. **VE-00→03 chiusi (backend completo, non distribuito); VE-04 e VE-05 aperti; Gate GVISUAL PENDING.** | Per progettare o implementare VE-04 e VE-05. |
