...
**Didattica (DUX) — redesign UX in corso, DUX-01–03 implementati.** DUX-00 (specifica + prototipo) e DUX-01–03 (libreria corsi, workspace corso, schede Contenuto/Domande/Informazioni con Question Editor contestuale) sono realizzati — vedi [didattica-ux-roadmap.md](didattica-ux-roadmap.md). Le sezioni legacy Corsi, Lezioni, Domande e Classi restano quelle attuali e pienamente funzionanti finché i pacchetti DUX-04→05 non le sostituiscono a fasi, con parità funzionale verificata a ogni passaggio.
...
| [didattica-ux-roadmap.md](didattica-ux-roadmap.md) | Specifica UX del redesign "Didattica" (DUX-00–05 + Gate GDUX): unifica Corsi/Lezioni/Domande in un unico workspace docente. **DUX-01–03 implementati (libreria corsi + workspace corso con schede Contenuto/Domande/Informazioni); DUX-04…05 da fare.** | Per consultare architettura informativa, invarianti di sicurezza/costo e roadmap DUX prima di iniziare DUX-04. |
